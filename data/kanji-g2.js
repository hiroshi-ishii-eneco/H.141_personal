...
window.KANJI_DATA_G2 = [
  {
    ...
    words: [
      ...
      { word: "手引き", reading: "てびき",     sentence: "あたらしい○○を読む。",         printable: true }
    ]
  },
  {
    kanji: "羽",
  ...
  },
  {
    ...
    words: [
      { word: "公園",   reading: "こうえん",   sentence: "あさ○○をさんぽする。",         printable: true },
      { word: "園長",   reading: "えんちょう", sentence: "○○先生があいさつする。",       printable: true },
      { word: "学園",   reading: "がくえん",   sentence: "あたらしい○○ができた。",       printable: true },
      { word: "花園",   reading: "はなぞの",   sentence: "○○できれいに見る。",           printable: true },
      { word: "入園",   reading: "にゅうえん", sentence: "いもうとが○○する。",           printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "遠い",   reading: "とおい",     sentence: "学校までは○○みちだ。",         printable: true },
      ...
      { word: "遠出",   reading: "とおで",     sentence: "やすみに○○をする。",           printable: true }
    ]
  },
  {
    kanji: "何",
    ...
    words: [
      ...
      { word: "何時",   reading: "なんじ",     sentence: "いま○○ですか。",               printable: true },
      { word: "何日",   reading: "なんにち",   sentence: "あと○○でやすみか。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "教科書", reading: "きょうかしょ", sentence: "あさ○○をひらく。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "夏日",   reading: "なつび",     sentence: "きょうは○○になった。",         printable: true },
      { word: "夏目",   reading: "なつめ",     sentence: "○○先生のお話を読む。",         printable: true },
      { word: "初夏",   reading: "しょか",     sentence: "○○のかぜがここちよい。",       printable: true },
      { word: "夏空",   reading: "なつぞら",   sentence: "あおい○○がひろがる。",         printable: true }
    ]
  },
  {
    kanji: "家",
    ...
    words: [
      { word: "家",     reading: "いえ",       sentence: "夕がたに○○へ帰る。",           printable: true },
      ...
      { word: "本家",   reading: "ほんけ",     sentence: "おしょうがつに○○へ行く。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "歌う",   reading: "うたう",     sentence: "大きなこえで○○。",             printable: true },
      { word: "歌手",   reading: "かしゅ",     sentence: "ゆうめいな○○が出る。",         printable: true },
      { word: "校歌",   reading: "こうか",     sentence: "学校の○○を歌う。",             printable: true },
      { word: "歌声",   reading: "うたごえ",   sentence: "となりから○○がきこえる。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "画用紙", reading: "がようし",   sentence: "○○にえをかく。",               printable: true },
      { word: "図画",   reading: "ずが",       sentence: "○○の時間が楽しい。",           printable: true },
      { word: "画力",   reading: "がりょく",   sentence: "あねは○○がある。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "会話",   reading: "かいわ",     sentence: "ふたりの○○がはずむ。",         printable: true },
      { word: "会社",   reading: "かいしゃ",   sentence: "父は○○へ行く。",               printable: true },
      { word: "大会",   reading: "たいかい",   sentence: "なつの○○に出る。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "海",     reading: "うみ",       sentence: "なつに○○へ行く。",             printable: true },
      ...
      { word: "大海",   reading: "たいかい",   sentence: "ふねで○○へ出る。",             printable: true },
      { word: "海原",   reading: "うなばら",   sentence: "ひろい○○を見わたす。",         printable: true }
    ]
  },
  {
    kanji: "絵",
  ...
  },
  {
    ...
    words: [
      ...
      { word: "外国",   reading: "がいこく",   sentence: "○○ごの歌をうたう。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "角笛",   reading: "つのぶえ",   sentence: "とおくで○○がなる。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "音楽",   reading: "おんがく",   sentence: "あさに○○をきく。",             printable: true },
      { word: "楽園",   reading: "らくえん",   sentence: "ここはこどもの○○だ。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "活用",   reading: "かつよう",   sentence: "じかんを○○する。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "時間",   reading: "じかん",     sentence: "○○をたいせつにする。",         printable: true },
      ...
      { word: "間口",   reading: "まぐち",     sentence: "お店の○○がひろい。",           printable: true }
    ]
  },
  {
    kanji: "丸",
    ...
    words: [
      ...
      { word: "丸い",   reading: "まるい",     sentence: "○○いつきが出た。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "岩山",   reading: "いわやま",   sentence: "とおくの○○を見る。",           printable: true },
      { word: "岩場",   reading: "いわば",     sentence: "○○でかにを見つけた。",         printable: true },
      { word: "大岩",   reading: "おおいわ",   sentence: "ふねが○○にぶつかる。",         printable: true },
      { word: "岩かげ", reading: "いわかげ",   sentence: "○○にさかなが入る。",           printable: true }
    ]
  },
  {
    kanji: "顔",
    ...
    words: [
      { word: "顔",     reading: "かお",       sentence: "あさに○○をあらう。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "汽力",   reading: "きりょく",   sentence: "○○ではしるきかん車。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "記入",   reading: "きにゅう",   sentence: "ようしに名前を○○。",           printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "弓",     reading: "ゆみ",       sentence: "むかしの人が○○をひく。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "牛にゅう", reading: "ぎゅうにゅう", sentence: "あさに○○をのむ。",         printable: true },
      { word: "子牛",   reading: "こうし",     sentence: "○○がうまれた。",               printable: true },
      { word: "牛車",   reading: "ぎっしゃ",   sentence: "むかしの○○の絵。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "魚市場", reading: "うおいちば", sentence: "あさの○○ははやい。",           printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "京",     reading: "きょう",     sentence: "むかしの○○のまち。",           printable: true },
      { word: "東京",   reading: "とうきょう", sentence: "あには○○にすむ。",             printable: true },
      { word: "京風",   reading: "きょうふう", sentence: "○○のおりょうり。",             printable: true },
      { word: "上京",   reading: "じょうきょう", sentence: "あには大学のため○○した。",   printable: true },
      { word: "京都",   reading: "きょうと",   sentence: "○○のおてらをたずねる。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "強行",   reading: "きょうこう", sentence: "あめでも遠足を○○。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "教室",   reading: "きょうしつ", sentence: "あさ○○に入る。",               printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "近づく", reading: "ちかづく",   sentence: "ふねがみなとに○○。",           printable: true }
    ]
  },
  {
    kanji: "兄",
  ...
  },
  {
    ...
    words: [
      { word: "形",     reading: "かたち",     sentence: "ねん土で○○をつくる。",         printable: true },
      { word: "三角形", reading: "さんかくけい", sentence: "○○をかみに書く。",           printable: true },
      ...
      { word: "弓形",   reading: "ゆみがた",   sentence: "そらに○○のにじ。",             printable: true }
    ]
  },
  {
    kanji: "計",
    ...
    words: [
      ...
      { word: "計画",   reading: "けいかく",   sentence: "なつ休みの○○を立てる。",       printable: true },
      { word: "合計",   reading: "ごうけい",   sentence: "おかねの○○を出す。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "草原",   reading: "そうげん",   sentence: "ひろい○○がつづく。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "雨戸",   reading: "あまど",     sentence: "夕がたに○○をしめる。",         printable: true },
      { word: "下戸",   reading: "げこ",       sentence: "父は○○だ。",                   printable: true },
      { word: "木戸",   reading: "きど",       sentence: "○○からそとに出る。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "中古",   reading: "ちゅうこ",   sentence: "○○のじてん車をかう。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "午後",   reading: "ごご",       sentence: "○○からあめがふる。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "後足",   reading: "あとあし",   sentence: "うまの○○が強い。",             printable: true }
    ]
  },
  {
    kanji: "語",
  ...
  },
  {
    ...
    words: [
      { word: "工作",   reading: "こうさく",   sentence: "図画○○のじかんだ。",           printable: true },
      ...
      { word: "人工",   reading: "じんこう",   sentence: "○○の池をつくる。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "公園",   reading: "こうえん",   sentence: "あさ○○をはしる。",             printable: true },
      { word: "公立",   reading: "こうりつ",   sentence: "あには○○の中学だ。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "交番",   reading: "こうばん",   sentence: "ちかくの○○で聞く。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "光る",   reading: "ひかる",     sentence: "ほしが夜空で○○。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "考える", reading: "かんがえる", sentence: "じぶんで○○ことが大切。",       printable: true },
      ...
      { word: "考案",   reading: "こうあん",   sentence: "あたらしいルールを○○する。",   printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "行く",   reading: "いく",       sentence: "あさ学校へ○○。",               printable: true },
      { word: "行う",   reading: "おこなう",   sentence: "学校でしきを○○。",             printable: true },
      { word: "行動",   reading: "こうどう",   sentence: "はやめの○○をとる。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "高原",   reading: "こうげん",   sentence: "なつ休みに○○でキャンプ。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "黄色",   reading: "きいろ",     sentence: "○○いはなを見つけた。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "谷間",   reading: "たにま",     sentence: "○○にむらがある。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "国王",   reading: "こくおう",   sentence: "○○のおはなしを読む。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "黒目",   reading: "くろめ",     sentence: "妹の○○がまるい。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "今月",   reading: "こんげつ",   sentence: "○○はあめがおおい。",           printable: true },
      { word: "今回",   reading: "こんかい",   sentence: "○○のたびはたのしかった。",     printable: true },
      { word: "今夜",   reading: "こんや",     sentence: "○○はほしがきれいだ。",         printable: true }
    ]
  },
  {
    kanji: "才",
  ...
  },
  {
    ...
    words: [
      ...
      { word: "細長い", reading: "ほそながい", sentence: "○○い紙をきる。",               printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "算用",   reading: "さんよう",   sentence: "○○すうじを書く。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "止まる", reading: "とまる",     sentence: "車があかしんごうで○○。",       printable: true },
      { word: "止める", reading: "とめる",     sentence: "水道のじゃ口を○○。",           printable: true },
      { word: "中止",   reading: "ちゅうし",   sentence: "あめで遠足が○○になる。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "矢じるし", reading: "やじるし", sentence: "地図に○○がかいてある。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "姉妹",   reading: "しまい",     sentence: "○○ふたりで歌をうたう。",       printable: true },
      { word: "義姉",   reading: "ぎし",       sentence: "兄のおくさんは○○だ。",         printable: true },
      { word: "長姉",   reading: "ちょうし",   sentence: "○○が家のいえをまもる。",       printable: true },
      { word: "姉上",   reading: "あねうえ",   sentence: "ものがたりで○○とよぶ。",       printable: true },
      { word: "お姉さん", reading: "おねえさん", sentence: "○○がうたを教えてくれる。",   printable: true }
    ]
  },
  {
    kanji: "思",
    ...
    words: [
      ...
      { word: "思い出", reading: "おもいで",   sentence: "なつの○○を話す。",             printable: true },
      { word: "思考",   reading: "しこう",     sentence: "○○力をきたえる。",             printable: true },
      { word: "思案",   reading: "しあん",     sentence: "○○に時間がかかる。",           printable: true },
      { word: "思い",   reading: "おもい",     sentence: "つよい○○がつたわる。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "切ぷ",   reading: "きっぷ",     sentence: "電車の○○をかう。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "光線",   reading: "こうせん",   sentence: "あさの○○がまぶしい。",         printable: true },
      { word: "電線",   reading: "でんせん",   sentence: "とりが○○にとまる。",           printable: true },
      { word: "海岸線", reading: "かいがんせん", sentence: "ながい○○を見る。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "赤組",   reading: "あかぐみ",   sentence: "○○がてんを入れた。",           printable: true }
    ]
  },
  {
    kanji: "走",
    ...
    words: [
      ...
      { word: "走り出す", reading: "はしりだす", sentence: "あいずで○○。",               printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "多い",   reading: "おおい",     sentence: "人が○○まちを歩く。",           printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "体",     reading: "からだ",     sentence: "あさに○○をうごかす。",         printable: true },
      { word: "体力",   reading: "たいりょく", sentence: "うんどうで○○をつける。",       printable: true },
      { word: "体育",   reading: "たいいく",   sentence: "○○のじかんが楽しい。",         printable: true },
      { word: "本体",   reading: "ほんたい",   sentence: "きかいの○○を見る。",           printable: true },
      { word: "体形",   reading: "たいけい",   sentence: "うまの○○をしらべる。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "土地",   reading: "とち",       sentence: "ひろい○○がある。",             printable: true },
      { word: "地元",   reading: "じもと",     sentence: "兄は○○の中学校に通う。",       printable: true },
      { word: "地名",   reading: "ちめい",     sentence: "ふるい○○のゆらいを知る。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "白昼",   reading: "はくちゅう", sentence: "○○のまちはにぎやかだ。",       printable: true }
    ]
  },
  {
    kanji: "長",
    ...
    words: [
      ...
      { word: "長女",   reading: "ちょうじょ", sentence: "あねは家の○○だ。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "通学",   reading: "つうがく",   sentence: "あさ○○の時間だ。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "義弟",   reading: "ぎてい",     sentence: "あねのつれあいは○○だ。",       printable: true },
      { word: "高弟",   reading: "こうてい",   sentence: "先生の○○がしどうする。",       printable: true },
      { word: "弟さん", reading: "おとうとさん", sentence: "○○がげんきにあいさつする。", printable: true }
    ]
  },
  {
    kanji: "店",
    ...
    words: [
      ...
      { word: "売店",   reading: "ばいてん",   sentence: "えきの○○でかう。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "電池",   reading: "でんち",     sentence: "とけいの○○をかえる。",         printable: true },
      { word: "電話",   reading: "でんわ",     sentence: "ともだちに○○する。",           printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "冬",     reading: "ふゆ",       sentence: "○○のあさはさむい。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "本当",   reading: "ほんとう",   sentence: "○○の話をきいてほっとする。",   printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "東西",   reading: "とうざい",   sentence: "ちずで○○のほうがくを見る。",   printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "口答",   reading: "こうとう",   sentence: "○○でこたえるしけん。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "同時",   reading: "どうじ",     sentence: "ふたりが○○にゴールした。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "売店",   reading: "ばいてん",   sentence: "プールの○○でジュースをかう。", printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "麦",     reading: "むぎ",       sentence: "○○ばたけがひろがる。",         printable: true },
      { word: "麦茶",   reading: "むぎちゃ",   sentence: "なつに○○をのむ。",             printable: true },
      { word: "小麦",   reading: "こむぎ",     sentence: "○○こでパンを作る。",           printable: true },
      { word: "麦畑",   reading: "むぎばたけ", sentence: "○○がどこまでもひろがる。",     printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "後半",   reading: "こうはん",   sentence: "○○からてんが入る。",           printable: true },
      { word: "半年",   reading: "はんとし",   sentence: "○○まえに学校に入った。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "交番",   reading: "こうばん",   sentence: "近くの○○できく。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "父母",   reading: "ふぼ",       sentence: "○○のあいに思う。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "風船",   reading: "ふうせん",   sentence: "あかい○○が空にとぶ。",         printable: true },
      { word: "南風",   reading: "みなみかぜ", sentence: "あたたかい○○がふく。",         printable: true },
      { word: "風土",   reading: "ふうど",     sentence: "○○のちがいを学ぶ。",           printable: true },
      { word: "風雪",   reading: "ふうせつ",   sentence: "つよい○○の中を歩く。",         printable: true }
    ]
  },
  {
    kanji: "分",
  ...
  },
  {
    ...
    words: [
      ...
      { word: "聞こえる", reading: "きこえる", sentence: "鳥のこえが○○。",               printable: true },
      { word: "新聞",   reading: "しんぶん",   sentence: "あさの○○を読む。",             printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "歩道",   reading: "ほどう",     sentence: "白いせんがある○○を歩く。",     printable: true },
      { word: "歩行",   reading: "ほこう",     sentence: "○○ちゅうにきをつける。",       printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "方",     reading: "かた",       sentence: "あちらの○○からこえがする。",   printable: true },
      { word: "方角",   reading: "ほうがく",   sentence: "東の○○をさす。",               printable: true },
      { word: "夕方",   reading: "ゆうがた",   sentence: "○○からあめだ。",               printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "北口",   reading: "きたぐち",   sentence: "デパートの○○からはいる。",     printable: true },
      { word: "北風",   reading: "きたかぜ",   sentence: "つめたい○○がふく。",           printable: true },
      { word: "東北",   reading: "とうほく",   sentence: "○○のお米はおいしい。",         printable: true },
      { word: "南北",   reading: "なんぼく",   sentence: "国土は○○にながい。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "義妹",   reading: "ぎまい",     sentence: "あにのつまは○○にあたる。",     printable: true },
      { word: "妹分",   reading: "いもうとぶん", sentence: "クラブで○○のような子。",     printable: true },
      { word: "妹さん", reading: "いもうとさん", sentence: "○○がうたを歌う。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "明星",   reading: "みょうじょう", sentence: "あさの○○が見える。",         printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "雷鳴",   reading: "らいめい",   sentence: "とおくで○○が聞こえる。",       printable: true }
    ]
  },
  {
    kanji: "毛",
  ...
  },
  {
    ...
    words: [
      { word: "門",     reading: "もん",       sentence: "校○○の前にたつ。",             printable: true },
      { word: "校門",   reading: "こうもん",   sentence: "あさ○○をくぐる。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "夜",     reading: "よる",       sentence: "○○のそらに星がきれいだ。",     printable: true },
      { word: "今夜",   reading: "こんや",     sentence: "○○はおまつりだ。",             printable: true },
      { word: "夜空",   reading: "よぞら",     sentence: "○○に月が出る。",               printable: true },
      { word: "夜風",   reading: "よかぜ",     sentence: "なつの○○にあたる。",           printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "野原",   reading: "のはら",     sentence: "ひろい○○をかけまわる。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "日曜",   reading: "にちよう",   sentence: "○○日はやすみだ。",             printable: true }
    ]
  },
  {
    kanji: "来",
    ...
    words: [
      { word: "来る",   reading: "くる",       sentence: "ともだちが家に○○。",           printable: true },
      ...
      { word: "出来る", reading: "できる",     sentence: "ひとりで○○ようになる。",       printable: true },
  ...
  },
  {
    ...
    words: [
      ...
      { word: "道理",   reading: "どうり",     sentence: "○○にあった話だ。",             printable: true },
  ...
  },
  {
    ...
    words: [
      { word: "話す",   reading: "はなす",     sentence: "ともだちと電話で○○。",         printable: true },
